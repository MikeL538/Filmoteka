...
var _fetcher = require("./js/fetcher");
var _language = require("./js/language");
var _scrolled = require("./js/scrolled");
var _mainScss = require("./scss/main.scss");
var _modalDetails = require("./js/modalDetails");
var _modalDetailsLibrary = require("./js/modalDetailsLibrary");
var _library = require("./js/library");
var _modalTeam = require("./js/modalTeam");
var _team = require("./js/team");

},{"./js/footer":"fXl6u","./js/fetcher":"iKrMr","./js/language":"9VbI5","./js/scrolled":"hKjuo","./scss/main.scss":"4Pg3x","./js/modalDetails":"iLvr3","./js/modalDetailsLibrary":"7iKIX","./js/library":"98Wmb","./js/modalTeam":"eHqPO","./js/team":"6fLBR"}],"fXl6u":[function(require,module,exports) {
const footer = document.querySelector(".footer");
const threshold = 800; // Height after which footer shows
function checkFooterVisibility() {
    if (window.scrollY > threshold) footer.classList.remove("hidden");
...
},{}],"iKrMr":[function(require,module,exports) {
...
(0, _axiosDefault.default).defaults.baseURL = "https://api.themoviedb.org/3/";
(0, _axiosDefault.default).defaults.headers.common["Authorization"] = "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxZjk0YzNhNWI0MDAwMDg5YWZhMWQ1YTFhZTk4YWIxZCIsInN1YiI6IjY1MGM4MmQzYjViYzIxMDEyY2M5ZmIwYiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.gbA2ivTkeIlFgOsCG0AQU95bbBmYrPkGm6ojq4z3dKo";
let currentPage = 1;
let isLoading = false;
...
const apiKey = "eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxZjk0YzNhNWI0MDAwMDg5YWZhMWQ1YTFhZTk4YWIxZCIsInN1YiI6IjY1MGM4MmQzYjViYzIxMDEyY2M5ZmIwYiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.gbA2ivTkeIlFgOsCG0AQU95bbBmYrPkGm6ojq4z3dKo";
// Encoding genreId to become clear genre name e.g. 28 => "Action"
function getGenreNameById(genreId) {
    const genre = genresData.genres.find((genre)=>genre.id === genreId);
    if ((0, _language.currentLanguage) === "pl-PL") return genre ? genre.namePl : "Nieznany gatunek";
    else return genre ? genre.name : "Unknown Genre";
}
...
if (document.querySelector(".films__list")) {
    function fetchMovies(page, searchQuery = "") {
        ...
        const params = {
            api_key: apiKey,
            language: (0, _language.currentLanguage),
            page: page,
            query: searchQuery
        };
        (0, _axiosDefault.default).get(trendingMoviesUrl, {
            params
        }).then((response)=>{
            ...
            setTimeout(()=>{
                if (movies.length === 0 && !scrolled) {
                    ...
                    (0, _notiflixDefault.default).Notify.failure("Search result not successful. Enter the correct movie name.");
                }
            }, 100);
            const movieList = movies.filter((movie)=>!renderedMovieIds.has(movie.id)).map(({ id , backdrop_path , title , release_date , genre_ids , vote_average  })=>{
                const imagePath = backdrop_path ? `https://image.tmdb.org/t/p/w500${encodeURIComponent(backdrop_path)}` : "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Image_not_available.png/640px-Image_not_available.png";
                ...
                if ((0, _language.currentLanguage) === "pl-PL") return `<li class="films__list-item" data-id="${id}">
          ...
          <p>${genreNames.slice(0, 2).join(", ")}  | <span>${release_date.substring(0, 4)}  </span><span class="films__list-item--rating">${roundedVoteAverage}</span></p>
                ...
                else return `<li class="films__list-item" data-id="${id}">
          <img src="${imagePath}" alt="${title}" />
          <h2>${title}</h2>
          <p>${genreNames.slice(0, 2).join(", ")}  |  <span>${release_date.substring(0, 4)}  </span><span class="films__list-item--rating">${roundedVoteAverage}</span></p>
        </li>`;
            ...
            movieItems.forEach((item)=>{
                item.addEventListener("click", (0, _modalDetails.showDetails));
            });
            filmsList.addEventListener("click", (0, _modalDetails.showDetails));
    ...
    function handleScroll() {
        ...
        if (scrollTop + clientHeight >= scrollHeight - 700 && !isLoading) {
            ...
            if (!isLoading || renderedMovieIds.size < 20) {
                noMoreMoviesLogged = true;
                (0, _notiflixDefault.default).Notify.info("No more movies to load :(");
            }
        }
    }
...
},{"axios":"jo6P5","./modalDetails":"iLvr3","./language":"9VbI5","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var Buffer = require("abe66b2b25a63d5c").Buffer;
"use strict";
/**
...
},{"abe66b2b25a63d5c":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("634a89fb4d7119fe");
var ieee754 = require("a66377a4e2036cb8");
...
},{"634a89fb4d7119fe":"eIiSV","a66377a4e2036cb8":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iLvr3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "populateModal", ()=>populateModal);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _language = require("./language");
...
document.addEventListener("click", (e)=>{
    ...
    if (modal && e.target === modal) closeDetails();
});
if (document.querySelector(".details")) document.addEventListener("keydown", (e)=>{
    if (e.key === "Escape") closeDetails();
});
if (detailsClose) detailsClose.addEventListener("click", ()=>{
    closeDetails();
});
...
document.addEventListener("click", (e)=>{
    const modal = document.querySelector(".details");
    if (modal && !modal.contains(e.target)) closeDetails();
});
...
function addingWatchedToLocalStorageWatched(movieId) {
    ...
    if (!watchedList.includes(movieId)) {
        ...
        (0, _notiflixDefault.default).Notify.success("Film added to watched!");
    } else (0, _notiflixDefault.default).Notify.failure("Movie is already in watched list.");
}
...
function addingQueueToLocalStorageQueue(movieId) {
    ...
    if (!queueList.includes(movieId)) {
        ...
        (0, _notiflixDefault.default).Notify.success("Movie added to queue!");
    } else (0, _notiflixDefault.default).Notify.failure("Movie is already in queue list.");
}
if (addWatched) {
...
function fetchMovieDetails(movieId) {
    ...
    (0, _axiosDefault.default).get(movieDetailsUrl, {
        params: {
            api_key: (0, _fetcher.apiKey),
            language: (0, _language.currentLanguage)
        }
    }).then((response)=>{
...
function populateModal(movieDetails) {
    ...
    const modalImgFound = movieDetails.backdrop_path ? `https://image.tmdb.org/t/p/w500${encodeURIComponent(movieDetails.backdrop_path)}` : "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Image_not_available.png/640px-Image_not_available.png";
...
},{"axios":"jo6P5","./language":"9VbI5","./fetcher":"iKrMr","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9VbI5":[function(require,module,exports) {
...
function translateElements() {
    ...
    elementsToTranslate.forEach((element)=>{
        ...
        if (element.tagName === "INPUT" && translationKey === "placeholder") element.placeholder = translationsForCurrentLanguage[translationKey];
        else element.textContent = translationsForCurrentLanguage[translationKey];
    });
}
...
},{}],"hKjuo":[function(require,module,exports) {
...
window.addEventListener("scroll", ()=>{
    if (isScrolling()) {
        ...
        if (headerForm && !header.matches(":hover")) headerForm.classList.add("form-transform");
        if (libraryButtons && !header.matches(":hover")) libraryButtons.classList.add("buttons-transform");
    } else {
        header.classList.remove("scrolled");
        headerNav.classList.remove("nav-height");
        headerContainer.classList.remove("scrolled-container");
        if (headerForm) setTimeout(()=>{
            headerForm.classList.remove("form-transform");
        }, 200);
        if (libraryButtons) setTimeout(()=>{
...
},{}],"4Pg3x":[function() {},{}],"7iKIX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "showLibraryDetails", ()=>showLibraryDetails);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _language = require("./language");
var _fetcher = require("./fetcher");
...
window.onload = function() {
    if (document.querySelector(".btn-watched")) watchedBtn.click();
};
// Dodawanie aktywnego przycisku (background)
if (document.querySelector(".btn-watched")) queuedBtn.addEventListener("click", ()=>{
    watchedBtn.classList.remove("button-active");
    queuedBtn.classList.add("button-active");
});
if (document.querySelector(".btn-watched")) watchedBtn.addEventListener("click", ()=>{
    watchedBtn.classList.add("button-active");
    queuedBtn.classList.remove("button-active");
});
function showLibraryDetails(e) {
    ...
    if (watchedBtn.classList.contains("button-active")) btnDeleteWatched.addEventListener("click", ()=>{
        detailsCloseLibrary.click();
        const movieId = modalElement.dataset.id;
        if (!movieId) {
            (0, _notiflixDefault.default).Notify.failure("No movie found in the watched list.");
            return;
        }
        const watchedList = JSON.parse(localStorage.getItem("watched")) || [];
    ...
    if (queuedBtn.classList.contains("button-active")) btnDeleteQueue.addEventListener("click", ()=>{
        const movieId = modalElement.dataset.id;
        if (!movieId) {
            (0, _notiflixDefault.default).Notify.failure("No movie found in the queued list.");
            return;
        }
    ...
    if (detailsCloseLibrary) detailsCloseLibrary.addEventListener("click", ()=>{
        closeDetails();
    });
...
function populateModal(movieDetails) {
    ...
    <ul class="details-library__information-list">
      ...
      ${movieDetails.vote_count}</span>
      <span>${movieDetails.popularity}</span>
      <span class="details-library__information-original-title">${movieDetails.original_title}</span>
      <span>${movieDetails.genres.map((genre)=>genre.name).join(", ")}</span>
      </li>
    </ul>
  `;
...
},{"axios":"jo6P5","./language":"9VbI5","./fetcher":"iKrMr","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"98Wmb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _language = require("./language");
var _fetcher = require("./fetcher");
var _modalDetailsLibrary = require("./modalDetailsLibrary");
//elementu filmu
function createMovieListItem(movieDetails) {
    ...
    movieListItem.addEventListener("click", ()=>{
        (0, _modalDetailsLibrary.showLibraryDetails)(movieDetails);
    });
...
if (btnWatched) btnWatched.addEventListener("click", ()=>{
    const watchedList = JSON.parse(localStorage.getItem("watched")) || [];
    displayMovieList(watchedList);
});
// obsługa "Queued"
const btnQueued = document.querySelector(".btn-queued");
if (btnQueued) btnQueued.addEventListener("click", ()=>{
    const queueList = JSON.parse(localStorage.getItem("queue")) || [];
...
if (document.querySelector(".library-films__list")) {
    ...
    btnWatched.addEventListener("click", ()=>{
        ...
        libraryFilmsList.innerHTML = "";
        const watchedList = JSON.parse(localStorage.getItem("watched")) || [];
        function fetchMovieDetails1(movieId) {
            const movieDetailsUrl = `movie/${movieId}`;
            (0, _axiosDefault.default).get(movieDetailsUrl, {
                params: {
                    api_key: (0, _fetcher.apiKey),
            ...
            <img src="${getMovieImagePath(movieDetails.backdrop_path)}" alt="${movieDetails.title}" />
            <h2>${movieDetails.title}</h2>
            <p>${genreNames} | <span>${movieDetails.release_date.substring(0, 4)}</span> <span class="films__list-item--rating">${movieDetails.vote_average}</span></p>
          `;
                // sprawdzam czy film już istnieje na liście
                const existingMovie = libraryFilmsList.querySelector(`[data-id="${movieDetails.id}"]`);
                if (!existingMovie) // jeśli nie, dodaj go
                libraryFilmsList.appendChild(movieListItem);
                movieListItem.addEventListener("click", (0, _modalDetailsLibrary.showLibraryDetails));
            }).catch((error)=>console.error("Error fetching movie details:", error));
        }
        function getMovieImagePath(path) {
            return path ? `https://image.tmdb.org/t/p/w500${encodeURIComponent(path)}` : "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Image_not_available.png/640px-Image_not_available.png";
        }
        watchedList.forEach((movieId)=>{
            fetchMovieDetails1(movieId);
        });
    });
}
...
},{"axios":"jo6P5","./language":"9VbI5","./fetcher":"iKrMr","./modalDetailsLibrary":"7iKIX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eHqPO":[function(require,module,exports) {
...
},{}],"6fLBR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "teamList", ()=>teamList);
var _avatarJpg = require("../images/avatar.jpg");
var _avatarJpgDefault = parcelHelpers.interopDefault(_avatarJpg);
var _michalWJpg = require("../images/MichalW.jpg");
var _michalWJpgDefault = parcelHelpers.interopDefault(_michalWJpg);
var _viaczeslavJpg = require("../images/Viaczeslav.jpg");
var _viaczeslavJpgDefault = parcelHelpers.interopDefault(_viaczeslavJpg);
var _mariuszGJpg = require("../images/MariuszG.jpg");
var _mariuszGJpgDefault = parcelHelpers.interopDefault(_mariuszGJpg);
const teamList = [
    {
        name: "Michał Lipiak",
        role: "Team Leader",
        github: "https://github.com/MikeL538",
        photo: (0, _avatarJpgDefault.default)
    },
    {
        name: "Michał W\xf3jcik",
        role: "Developer / Scrum Master",
        github: "https://github.com/michalwojcik4",
        photo: (0, _michalWJpgDefault.default)
    },
    {
    ...
    },
    {
        ...
        photo: (0, _viaczeslavJpgDefault.default)
    },
    {
        name: "Tomek Cekała",
        role: "Developer",
    ...
    },
    {
        ...
        photo: (0, _mariuszGJpgDefault.default)
    }
];

},{"../images/avatar.jpg":"lqTlp","../images/MichalW.jpg":"2z0PI","../images/Viaczeslav.jpg":"iY0s7","../images/MariuszG.jpg":"5X2cs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lqTlp":[function(require,module,exports) {
module.exports = require("c1b2d2a5c6c8f639").getBundleURL("bLxZJ") + "avatar.7a890261.jpg" + "?" + Date.now();

},{"c1b2d2a5c6c8f639":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"2z0PI":[function(require,module,exports) {
module.exports = require("476bd1f3641447ff").getBundleURL("bLxZJ") + "MichalW.b3496400.jpg" + "?" + Date.now();

},{"476bd1f3641447ff":"lgJ39"}],"iY0s7":[function(require,module,exports) {
module.exports = require("478a245f28dbc0f9").getBundleURL("bLxZJ") + "Viaczeslav.e942777a.jpg" + "?" + Date.now();

},{"478a245f28dbc0f9":"lgJ39"}],"5X2cs":[function(require,module,exports) {
module.exports = require("8e6b343036bea285").getBundleURL("bLxZJ") + "MariuszG.eebfa1e3.jpg" + "?" + Date.now();

},{"8e6b343036bea285":"lgJ39"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequired76b")
